// client-one-side.js - Handles one-sided products for client art application
...
export function initialize(state, elements, ctx) {
    console.log("Initializing one-sided product mode for client");
...
export function renderCanvas(state, elements, ctx, baseImages, imagesLoaded) {
    ...
    console.log("Rendering one-sided canvas for client");
...
export function initializeOverlayPosition(state, elements) {
    ...
    console.log("Initializing overlay position for one-sided product");
